...
disease_simulation/
|-- simulation/
|   |-- agent.py         # logika agenta
|   |-- model.py         # model i siatka
|   `-- visualization.py # serwer wizualizacji
|-- experiments/
|   `-- experiments.py   # eksperymenty batch
|-- figures/             # wykresy wynikowe
`-- report/              # raport LaTeX
\end{lstlisting}
...
\begin{figure}[H]
  ...
  Zacieniowane obszary reprezentują odchylenie standardowe z 20 uruchomień.}
  \label{fig:exp1}
\end{figure}
